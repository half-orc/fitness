...
<header class="demos-header">
	<h1 class="demos-title">
		...
		<p>角色列表&nbsp;<img src="<?php echo base_url() ; ?>static/images/add.png" onclick="window.location.href='<?php echo base_url() ; ?>sys/admin_role/detail/'"></p>
	</h1>
</header>
...
function getData(pages){
	$.ajax({
		...
		url:$('#host').val()+'sys/admin_role/getData/'+pages,
